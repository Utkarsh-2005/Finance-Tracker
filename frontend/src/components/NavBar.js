...
function NavBar(props) {
  ...
  return (
    <div>
         ...
         <div className=' flex flex-row  justify-between w-full h-24 bg-neutral-950' >
          <div className='left text-red-500 font-bold font-Handjet tracking-wider text-6xl top-5 left-10 relative hidden sm:block'>
        ...
        <div className='flex flex-row sm:justify-end justify-between sm:w-1/3 w-full'>
        ...
        <div className='px-3'>
          <a onClick={logoutHandle} href="#_" className="text-xl mt-5 mb-5 relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group">
